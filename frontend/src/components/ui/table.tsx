...
>(({ className, ...props }, ref) => (
  <thead ref={ref} className={cn("[&_tr]:border-b [&_tr]:border-border-sm", className)} {...props} />
))
...
>(({ className, ...props }, ref) => (
  <tbody
    ref={ref}
    className={cn("[&_tr:last-child]:border-0 [&_tr]:border-border-sm", className)}
    {...props}
  />
))
...
>(({ className, ...props }, ref) => (
  <tfoot
    ref={ref}
    className={cn(
      "border-t border-border-sm bg-muted/50 font-medium [&>tr]:last:border-b-0",
      className
    )}
    {...props}
  />
...
>(({ className, onClick, ...props }, ref) => {
  return (
    <tr
      ref={ref}
      className={cn(
        "border-b border-border-sm transition-colors hover:bg-muted/50 data-[state=selected]:bg-muted",
