...
class TaskStatusRelationSchemes:
    """Клас для організації всіх SQL схем зв'язків статусів завдань"""
    CREATE_TABLE_TASK_STATUS_RELATIONS = CREATE_TABLE_TASK_STATUS_RELATIONS
    CREATE_TASK_STATUS_RELATION = CREATE_TASK_STATUS_RELATION
    GET_TASK_STATUS_RELATIONS_BY_PROJECT_ID = GET_TASK_STATUS_RELATIONS_BY_PROJECT_ID
    GET_TASK_STATUS_RELATIONS_BY_TASK_STATUS_ID = GET_TASK_STATUS_RELATIONS_BY_TASK_STATUS_ID
    GET_TASK_STATUS_RELATION_BY_ID = GET_TASK_STATUS_RELATION_BY_ID
    UPDATE_TASK_STATUS_RELATION_BY_ID = UPDATE_TASK_STATUS_RELATION_BY_ID
    DELETE_TASK_STATUS_RELATION_BY_ID = DELETE_TASK_STATUS_RELATION_BY_ID 